...
\thispagestyle{fancy}
\cfoot{Copyright \textcopyright \ 2019 Brian Schubert}
...
%    \end{tabularx}
    ...
    \begin{definition*}[Laplace Transform]
        ...
        Remark 1. Note $\mathcal L\{f(x)\}$ is a function of a different variable $s$, and that $\mathcal L$ is linear with respect to $f$.
